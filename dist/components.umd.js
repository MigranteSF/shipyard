...
// CONCATENATED MODULE: ./src/components/SelectForm/SelectForm.vue?vue&type=template&id=3cb7266b&
...
// CONCATENATED MODULE: ./src/utils/placement.js
var placement = function placement(el) {
  var bounding = el.getAttribute('x-placement') == 'bottom' ? el.getBoundingClientRect().top : el.getBoundingClientRect().bottom + el.parentElement.offsetHeight + 6;

  if (bounding + el.offsetHeight > window.innerHeight) {
    el.style.top = "unset";
    el.style.bottom = "".concat(el.parentElement.offsetHeight + 6, "px");
    el.setAttribute('x-placement', 'top');
  } else {
    el.style.bottom = "unset";
    el.style.top = "".concat(el.parentElement.offsetHeight, "px");
...
/* harmony default export */ var SelectFormvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    outList: function outList() {
      ...
      if (((_this$$refs$list = this.$refs.list) === null || _this$$refs$list === void 0 ? void 0 : _this$$refs$list.style.display) == "none") return;
      this.displayTimes++;
...
// CONCATENATED MODULE: ./src/directives/click-outside/index.js


// CONCATENATED MODULE: ./src/directives/out-view/out-view.js

var out_view_directive = {
...
var outView = {
  name: 'out-view',
  directive: out_view_directive
};
// CONCATENATED MODULE: ./src/directives/out-view/index.js


// CONCATENATED MODULE: ./src/directives/index.js


var directives = [clickOutside, outView];
...
var registerDirective = function registerDirective(Vue, name, def) {
  if (Vue && name && def) Vue.directive(name, def);
};
